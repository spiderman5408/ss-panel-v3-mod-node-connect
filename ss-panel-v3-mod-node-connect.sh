...
install_ubuntu_ssr(){
	...
	pip install cymysql
	cd /root
	git clone -b master https://github.com/spiderman5408/shadowsocks.git "/root/shadowsocks"
	cd shadowsocks
...
install_node(){
	...
	echo "# Github: https://github.com/spiderman5408/ss-panel-v3-mod-node-connect   "
